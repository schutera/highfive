...
| **Google Maps JavaScript API** | outbound (browser-side) | Loaded by `homepage` for the map view | API key currently hardcoded in `ESP32-CAM/esp_init.cpp`'s `getGeolocation` — see [issue #18](https://github.com/schutera/highfive/issues/18) and [11-risks-and-technical-debt](../11-risks-and-technical-debt/README.md) |
