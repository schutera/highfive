...
- [production-deployment.md](production-deployment.md) — production via `docker-compose.prod.yml` + Nginx reverse proxy (API only — frontend container binds 80/443 directly) + Let's Encrypt
