...
| **`VITE_ENABLE_DASHBOARD_IMAGES`** | The first homepage build-time feature flag: gates the public dashboard "Latest captures" gallery (`LatestCaptures` in `ModulePanel.tsx`, #154). Off in production; the dev `docker-compose.yml`, the UI-test stack, and `vitest.config.ts` set it `'true'`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | dashboard-images flag (qualify the var name)  |
