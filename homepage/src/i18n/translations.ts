const translations = {
  en: {
    ...
    modulePanel: {
      ...
      firmwareTooltip: 'Firmware version reported by the module on its last heartbeat',
      nest: 'Nest {index}',
      moduleNotFound: 'Module not found',
      failedToLoad: 'Failed to load module details',
      nestSnips: 'Nest holes',
      nestSnipsHint: 'Drag the slider to scrub all holes across captures',
      snipSealed: 'Sealed',
      snipEmpty: 'Empty',
    ...
    hiveModule: {
      ...
      electronicsSubtitle:
        'These parts are available from Amazon, AliExpress, or your local electronics store. The module can be powered via a USB cable plugged directly into the dev board.',
      basicTitle: 'Basic',
      ...
      antennaDesc: '2.4 GHz WiFi antenna with IPEX connector for better range',
      devBoard: 'Dev Board',
      devBoardDesc: 'ESP32-CAM-MB programmer and USB power supply board',
      screws: 'Small Screws',
      screwsDesc: '4 small screws for mounting the ESP32-CAM inside the module',
      currentSensor: 'Current Sensor',
      currentSensorDesc: 'INA219 I2C bidirectional current/power monitoring module (CJMCU-219)',
      headerPins: 'Header Pins',
      headerPinsDesc: '4 pins, soldered onto the INA219 module',
      jumperWires: 'Jumper Wires',
      jumperWiresDesc: '4 female-to-female jumper wires for connecting the INA219 to the ESP32',
      usbCAdapter: '2-Pin to USB-C Adapter',
      usbCAdapterDesc: '2-pin connector to USB-C for solar power input',
      microUsbAdapter: '2-Pin to Micro USB Adapter',
      microUsbAdapterDesc: '2-pin connector to Micro USB for dev board power supply',
      // Self-sufficient parts
      pvModule: 'PV Module',
      pvModuleDesc: '70\u00D7100 mm, 5 V, 1 W, 200 mA, 2 mm thick',
      chargeController: 'Charge Controller',
      chargeControllerDesc: 'CN3791 MPPT single-cell module',
      wagoClamp: 'Wago Clamp',
      wagoClampDesc: '2-conductor compact splicing connector (e.g. Wago 221-412)',
      batteryHolder: 'Battery Holder',
      batteryHolderDesc: '18650 single-cell holder with two cables, 75\u00D720\u00D720 mm',
      batteryPack: 'Battery',
      batteryPackDesc: 'Samsung INR18650-35E, Flat-Top, Li-Ion, 3.7 V, 3400 mAh',
      bms: 'BMS',
  ...
  de: {
    ...
    modulePanel: {
      ...
      images: 'Bilder',
      firmware: 'Firmware {version}',
      firmwareTooltip: 'Vom Modul beim letzten Heartbeat gemeldete Firmware-Version',
      nest: 'Nest {index}',
      moduleNotFound: 'Modul nicht gefunden',
      failedToLoad: 'Moduldetails konnten nicht geladen werden',
      nestSnips: 'Nistlöcher',
      nestSnipsHint: 'Schieberegler ziehen, um alle Löcher über Aufnahmen zu durchblättern',
    ...
    hiveModule: {
      ...
      electronicsSubtitle:
        'Diese Teile sind bei Amazon, AliExpress oder deinem lokalen Elektronikladen erh\u00E4ltlich. Das Modul kann \u00FCber ein USB-Kabel direkt am Dev Board mit Strom versorgt werden.',
      basicTitle: 'Basis',
      ...
      antennaDesc: '2,4 GHz WLAN-Antenne mit IPEX-Anschluss f\u00FCr bessere Reichweite',
      devBoard: 'Dev Board',
      devBoardDesc: 'ESP32-CAM-MB Programmer und USB-Stromversorgungsplatine',
      ...
      jumperWiresDesc: '4 Female-to-Female Jumperkabel zum Verbinden des INA219 mit dem ESP32',
      ...
      wagoClamp: 'Wago-Klemme',
      wagoClampDesc: '2-Leiter Kompakt-Verbindungsklemme (z.\u00A0B. Wago 221-412)',
      batteryHolder: 'Batteriehalter',
      batteryHolderDesc: '18650 Einzelzellenhalter mit zwei Kabeln, 75\u00D720\u00D720 mm',
      batteryPack: 'Akku',
      batteryPackDesc: 'Samsung INR18650-35E, Flat-Top, Li-Ion, 3,7 V, 3400 mAh',
      bms: 'BMS',
