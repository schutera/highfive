const translations = {
  en: {
    ...
    step4: {
      ...
      passwordMinHint: 'Min 8 characters (WPA2)',
  ...
  de: {
    ...
    dashboard: {
      ...
      onlineCount: '{online}/{total}',
      noModulesConnected: 'Keine Module verbunden',
      statusOnline: '\u25CF Online',
      statusOffline: '\u25CB Offline',
    ...
    step4: {
      ...
      passwordMinHint: 'Mindestens 8 Zeichen (WPA2)',
      passwordToggle: 'Passwort-Sichtbarkeit umschalten',
