      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link 
              to="/dashboard"
              className="bg-amber-500 hover:bg-amber-600 text-white px-12 py-5 rounded-full text-xl font-semibold shadow-2xl transition-all transform hover:scale-105"
            >
              View Dashboard
            </Link>
            <a 
              href="#how-it-works"
              className="bg-white/10 backdrop-blur-md hover:bg-white/20 text-white px-12 py-5 rounded-full text-xl font-semibold border-2 border-white/30 transition-all"
            >
              How It Works
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-12 max-w-2xl mx-auto">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-amber-400 to-orange-500 w-16 h-16 rounded-full flex items-center justify-center text-white text-3xl font-bold mb-6 shadow-lg">
                1
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Get Hardware</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Choose your preferred option to get started with the monitoring hardware.
              </p>
              
              {/* Option 1: Buy Kit */}
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-4 mb-4 border-2 border-amber-200">
                <h4 className="font-bold text-gray-900 mb-2">🎁 Complete Kit</h4>
                <p className="text-sm text-gray-600 mb-3">
                  Get everything pre-assembled and ready to use
                </p>
                <a 
                  href="#buy-kit" 
                  className="inline-block w-full bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg font-semibold text-center transition-colors"
                >
                  Buy Complete Kit →
                </a>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                <h4 className="font-bold text-gray-900 mb-2">🔧 Build It Yourself</h4>
                ...
                <a 
                  href="#diy-guide" 
                  className="inline-block w-full bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg font-semibold text-center transition-colors"
                >
                  View Parts List →
                </a>
              </div>
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Flash & Setup</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Connect your ESP32-CAM to your computer and use our installer to flash the firmware.
              </p>
              
              <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-200">
                <h4 className="font-bold text-gray-900 mb-2">📡 Web Installer</h4>
                <p className="text-xs text-gray-600 mb-3">
                  Simple browser-based installer - works on all platforms, no downloads or drivers needed
                </p>
                <a 
                  href="#web-installer" 
                  className="inline-block w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold text-center transition-colors"
                >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Discover & Contribute</h3>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Set up your hive module and monitor wild bee populations and contribute valuable data to help understand pollinator health in your area. 
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 mb-4 border-2 border-green-200">
              ...
              <Link 
                to="/dashboard"
                className="mt-2 inline-block w-full bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-semibold text-center transition-colors"
              >
                Explore Dashboard →
              </Link>
            </div>
