...
This is the single source of truth for module ID validation in
image-service. The duckdb-service ships an identical copy in its
``models/module_id.py`` — Python has no npm-style workspace mechanism,
