...
// ===========================
// WiFi credentials are now read from secrets.h
// ===========================
#include "secrets.h"
...
// Setup LED FLash if LED pin is defined in camera_pins.h
  ...
  Serial.println("Waiting for WiFi connection result...");
  int wifiResult = WiFi.waitForConnectResult();
  if (wifiResult == WL_CONNECTED) {
    ...
    Serial.print("waitForConnectResult() returned: ");
